...
- `melt()`: Sirve para agrupar las variables que se encuentran en columnas
- `cast()`: 

```{r, melt-cast-graph, echo=F}
...
Pueden consultar el siguiente enlace en [Data_Camp](datacamp_wide_long) para reforzar los conceptos. 
...
[Data_Camp]: https://www.datacamp.com/community/tutorials/long-wide-data-R